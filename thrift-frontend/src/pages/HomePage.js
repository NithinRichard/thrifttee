    ...
    <div className="min-h-screen">
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <motion.div
            ...
            className="text-center mobile-spacing-lg"
          >
            <h2 className="mobile-text-2xl sm:text-3xl md:text-4xl font-vintage font-bold text-gray-900 mb-3 md:mb-4">
              Featured Finds
            </h2>
            <p className="mobile-text-base sm:text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mobile-spacing-sm leading-relaxed">
          ...
          >
            <Link
              to="/products"
              className="mobile-button mobile-button-primary text-lg px-8 py-3 inline-block"
            >
              Shop All Products
            </Link>
          </motion.div>
      ...
      <section className="py-16 bg-gradient-vintage">
        <div className="mobile-container">
          <div className="mobile-grid gap-8 items-center">
            <motion.div
              initial={{ opacity: 0, x: -50 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.6 }}
            >
              <h2 className="mobile-text-2xl font-vintage font-bold text-gray-900 mb-4">
                Sustainable Fashion with Character
              </h2>
              <p className="mobile-text-lg text-gray-700 mb-6">
              ...
              <div className="mobile-grid grid-cols-2 gap-4">
                <div className="text-center">
                  <div className="mobile-text-xl font-bold text-vintage-600 mb-2">500+</div>
                  <div className="mobile-text-base text-gray-600">Unique Pieces</div>
                </div>
                <div className="text-center">
                  <div className="mobile-text-xl font-bold text-vintage-600 mb-2">100%</div>
                  <div className="mobile-text-base text-gray-600">Quality Checked</div>
                </div>
              </div>
            </motion.div>
