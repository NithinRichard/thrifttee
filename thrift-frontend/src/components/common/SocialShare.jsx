...
const SocialShare = ({ url, title, image }) => {
  ...
  const shareLinks = {
    ...
    pinterest: `https://pinterest.com/pin/create/button/?url=${encodeURIComponent(shareUrl)}&description=${encodeURIComponent(shareTitle)}${image ? `&media=${encodeURIComponent(image)}` : ''}`,
  };
